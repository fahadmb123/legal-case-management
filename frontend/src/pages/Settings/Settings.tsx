...
function Settings() {
  ...
  const [advocateName, setAdvocateName] = useState(user?.name || "");
  ...
  const handlePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 5 * 1024 * 1024) {
      showToast("File is too large. Maximum size is 5MB.");
      return;
    }
    ...
    try {
      ...
      updateUser({ profilePhoto: res.photoUrl });
    ...
    <div className="settings-grid-container">
      ...
      >
        ...
        <div className="settings-card-content">
          ...
          <p>Official legal identifiers displayed on judicial notices, vakalatnamas, and client representations.</p>
        </div>
      </div>
      ...
      >
        ...
        <div className="settings-card-content">
          ...
          <p>Select your preferred visual environment for judicial readability.</p>
        </div>
      </div>
      ...
      >
        ...
        <div className="settings-card-content">
          ...
          <p>Protect privileged work product with encrypted password controls.</p>
        </div>
      </div>
      ...
      >
        ...
        <div className="settings-card-content">
          ...
          <p>Export complete chamber dockets or end authenticated sessions.</p>
        </div>
      </div>
    </div>
  );
  ...
  const renderDetailHeader = (title: string) => (
    <div className="settings-detail-header">
      <button 
        ...
        aria-label="Back to Settings Grid"
      >
          ...
          <div className="settings-detail-content">
            ...
            {activeTab === "profile" && (
              <section className="settings-section-card">
                {renderDetailHeader("Advocate & Chamber Profile")}
            ...
            {activeTab === "appearance" && (
              <section className="settings-section-card">
                {renderDetailHeader("Interface Appearance")}
                <p className="section-desc">
            ...
            {activeTab === "security" && (
              <section className="settings-section-card">
                {renderDetailHeader("Security & Master Password")}
                <p className="section-desc">
            ...
            {activeTab === "account" && (
              <section className="settings-section-card">
                {renderDetailHeader("Account & Data Operations")}
                <p className="section-desc">
